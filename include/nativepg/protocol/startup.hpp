...
std::error_code serialize(const startup_message& msg, std::vector<unsigned char>& to);

struct ssl_request
{
};
std::error_code serialize(ssl_request msg, std::vector<unsigned char>& to);
...
std::error_code serialize(const password& msg, std::vector<unsigned char>& to);

// Authentication messages require parsing the following 4 bytes, too
struct authentication_ok
{
};
inline std::error_code parse(std::span<const unsigned char> data, authentication_ok&)
{
...
inline std::error_code parse(std::span<const unsigned char> data, authentication_kerberos_v5&)
{
    return detail::check_empty(data);
}
...
inline std::error_code parse(std::span<const unsigned char> data, authentication_cleartext_password&)
{
    return detail::check_empty(data);
}
...
std::error_code parse(std::span<const unsigned char> data, authentication_md5_password&);

struct authentication_gss
{
};
inline std::error_code parse(std::span<const unsigned char> data, authentication_gss&)
{
    return detail::check_empty(data);
}
...
inline std::error_code parse(std::span<const unsigned char> data, authentication_gss_continue& to)
{
    to.data = data;
    return {};
}
...
inline std::error_code parse(std::span<const unsigned char> data, authentication_sspi&)
{
    return detail::check_empty(data);
}
...
std::error_code parse(std::span<const unsigned char> data, authentication_sasl&);
...
inline std::error_code parse(std::span<const unsigned char> data, authentication_sasl_final& to)
{
    to.data = data;
    return {};
}
...
std::error_code parse(std::span<const unsigned char> data, negotiate_protocol_version& to);
