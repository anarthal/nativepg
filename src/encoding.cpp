...
// The names the server uses for client_encoding, which are the enumerator
// names in uppercase. Listed in enum declaration order.
//   https://www.postgresql.org/docs/current/multibyte.html
constexpr std::array<encoding_entry, 42> encoding_entries{
    {{"BIG5", encoding::big5},
...
std::optional<encoding> nativepg::parse_encoding(std::string_view name)
{
