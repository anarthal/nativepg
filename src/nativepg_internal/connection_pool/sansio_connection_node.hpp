...
#ifndef NATIVEPG_SANSIO_CONNECTION_NODE_HPP
#define NATIVEPG_SANSIO_CONNECTION_NODE_HPP
...
public:
    ...
    next_connection_action resume(std::error_code ec, collection_state col_st)
    {
        switch (status_)
        {
