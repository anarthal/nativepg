...
void test_usual_workflow()
{
    ...
    buff.commit(8u);
    test_range_eq(buff.committed_area(), data);
    ...
    buff.consume(3u);
    test_range_eq(buff.committed_area(), std::span(data).subspan(3));
    BOOST_TEST_EQ(buff.prepared_area().size(), 4088u);
...
void test_move()
{
    ...
    test_range_eq(moved.committed_area(), data);
    ...
    test_range_eq(assigned.committed_area(), data);
...
void test_two_consumes()
{
    ...
    buff.consume(5u);
    test_range_eq(buff.committed_area(), std::span(data).last(3));
    BOOST_TEST_EQ(buff.prepared_area().size(), 8u);
...
void test_prepare_reallocates_drops_consumed()
{
    ...
    buff.prepare(24u);
    test_range_eq(buff.committed_area(), std::span(data).last(8));
    BOOST_TEST_EQ(buff.prepared_area().size(), 24u);
}
...
void test_prepare_memmoves()
{
    ...
    buff.prepare(4u);
    test_range_eq(buff.committed_area(), std::span(data).last(6));
